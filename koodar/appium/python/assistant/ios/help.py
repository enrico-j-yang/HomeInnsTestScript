...
class KoodarIOSAssistantHelpAtomTests(unittest.TestCase):
    ...
    def help_topic(self):
        ...
        # enter my account 
        self.testStep.wait_widget("//UIACollectionCell[@name='帮助与反馈']")
        #click into Navigation
        self.testStep.tap_widget("//UIACollectionCell[@name='帮助与反馈']")
        
        # wait for my account activity
        self.testStep.wait_widget("//UIAStaticText[@name='帮助与反馈']")
        # enter account info
    ...
    atom_test_list = {'help_topic':help_topic
                        }
            
class KoodarIOSAssistantHelpTests(unittest.TestCase):
    think_time = 3
    ...
    def setUp(self):
        ...
        self.atomTest = KoodarIOSAssistantHelpAtomTests(self.testStep, desired_caps['platformName'])
